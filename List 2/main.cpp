...
//Class<int> obj1;  //шаблоенные поля будут типа 'int';
//Class<double> obj2;  //шаблонные поля будут типа 'double';

///////////////////////////////////////////////////////////////////////////////
//////////	    	Class declaration (Объявлениее класса)		 	 //////////
...
class List
{
	...
	//В одном выражении можно объявить несколь переменных одного типа, 
	// один раз указав тип данных, и перечислив имена объявляемых переменных, через запятую.
...
///////////////////////////////////////////////////////////////////////////////
//////////	    	Class definition (Опредление класса)			//////////
...
template<typename T>void List<T>::insert(T Data, T Index)
{
...
{
	if (Head == nullptr && Tail == nullptr)return; //1 if
	//				Частный случай:
	if (Head == Tail)
	{
	...
	size--;
	//Как бы у нас не происходило удаление, 1 if - не даст выполнить size--
}
...
//////////	     Class definition end (Конец предление класса)		  //////////
///////////////////////////////////////////////////////////////////////////////
